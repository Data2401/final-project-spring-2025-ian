...
```{r smoking and diabetes, echo=FALSE}
...
```{r Plot smoking and diabetes, echo=FALSE}
...
```{r heart disease and smoking, echo=FALSE}
...
```{r Heart Disease and Smoking Graph, echo=FALSE}
...
```{r Smoking and hypertension, echo=FALSE}
...
```{r Smoking and Hypertension Graph, echo=FALSE}
...
```{r Age by smoking category, echo=FALSE}
...
```{r Age and health issues, echo=FALSE}
#AGE VS DIABETES
...
```{r age vs heart disease, echo=FALSE}
...
```{r age vs hypertension, echo=FALSE}
age_vs_hypertension
