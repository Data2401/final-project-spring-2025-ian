...
library(knitr)
#diabetes_dataset
kable(head(diabetes_dataset, 10), caption = "Diabetes Dataset Sample First 10 Rows Only - Sample")
```
...
#HbA1c_by_gender
kable(head(HbA1c_by_gender, 10), caption = "Males vs. Females HbA1c Category Based on HbA1c Levels - Sample")
