...
# in this section we want our stack bar to follow a certain order, we want Normal at the top, Prediabetes at the middle, and Diabetes at the bottom. To do this we will mutate our diabetes_category column to an ordered categorical variable with the use of the factor function and the levels argument helps to set the order we want.
HbA1c_by_gender <- HbA1c_by_gender %>%
  mutate(diabetes_category = factor(diabetes_category, levels = c("Normal", "Prediabetes", "Diabetes")))
