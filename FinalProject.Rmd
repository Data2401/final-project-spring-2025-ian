...
datatable(diabetes_dataset, options = list(
  pageLength = 10,    # Display more rows (adjust as needed)
  scrollY = "400px",  # Enables vertical scrolling
  autoWidth = TRUE    # Adjusts column width
))

#diabetes_dataset
#kable(head(diabetes_dataset, 6), caption = "100,000 × 11 (first 6 rows)")
```
...
interactive_combined_data <- ggplot(combined_data) +
