...
For our first plot we filtered our data to categorize males and females as diabetic, pre-diabetic, and normal based on blood sugar levels(HbA1c). To do this we selected the variables of interest which are gender, diabetes, and HbA1c_level. From the first table shown we are able to see that blood sugar levels not necessarily define the diabetes status of the individuals within our data set.
...
**Whats the correlation between blood glucose levels and diabetes?**
